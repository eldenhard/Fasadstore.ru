<template>
    <div class="container-block">
        ...
        <p align="center" style="color: rgb(83, 83, 83)">Бесплатная консультация со специалистом по пластиковым окнам</p>
...
.container-block {
  ...
  overflow: hidden;
  background: #082c43;
  box-shadow: -31px 31px 65px #041724, 31px -31px 65px #0c4162;
