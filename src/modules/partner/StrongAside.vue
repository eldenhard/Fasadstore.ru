      ...
      <div class="content_block">
        <div class="left_aside">
          ...
          <p>
            ...
            регионах. <br />
            ООО «Алюминиевые ситемы» — компания полного цикла, которая выполняет все виды работ «под
            ключ» — от проектирования до монтажа и обслуживания систем.
          </p>
        </div>
        <div class="right_aside">
          ...
          <div class="raiting">
            <section class="alumanium">
              ...
              <br />
              <span
                >Поддерживает горение: <strong style="color: #d683ce">Не поддерживает</strong></span
              >
              <br /><br />
    ...
    <section class="white_block">
      <div class="content_grid_block">
        ...
        <div class="create">
          ...
          <p class="text">
            Монтажное подразделение компании выполняет весь комплекс работ в соответствии с ГОСТом
          </p>
        </div>
        <div class="support">
          <svg
