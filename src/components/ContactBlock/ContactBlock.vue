    ...
    <div class="planet">
      <section class="form_block">
        <form action="" class="form">
          <p><b>Оставьте заявку</b> и Вам перезвонит менеджер</p>
          <label for=""
            >Имя<sup>*</sup> <br />
        ...
        <div class="black_block">
          ...
          <div class="mini_block">
            ...
            <div class="text_mini">
              ...
              <a class="description_second" href="https://yandex.ru/maps/-/CDBimGN~" target="_blank"
                >Москва Дмитровское шоссе 157 стр. 7</a
              >
            </div>
          </div>
          <div class="mini_block">
