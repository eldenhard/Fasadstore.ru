<template>
    <section class="about">
        ...
        <div class="about_right">
            <h3>Офис ООО «Алюминиевые Системы»</h3>
            <h5>Бизнес Центр «Гефест», <br> г. Москва,
                Дмитровское шоссе, 157, стр. 7, м. Лианозово</h5>
            <div class="description">
                ...
                <ol>
                    ...
                    <li>Изготовить за 7-14 дней алюминиевое остекление нужного размера и формы. Окрасить в выбранный
                        вами
...
img {
    ...
    &:hover {
        -webkit-box-shadow: -4px 3px 34px -2px rgba(194, 194, 194, 1);
        -moz-box-shadow: -4px 3px 34px -2px rgba(194, 194, 194, 1);
