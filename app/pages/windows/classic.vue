...
// Страница классических алюминиевых окон — /windows/classic
...
useSchemaOrg({
  type: 'Product',
  data: {
    name: 'Классические алюминиевые окна ALUTECH',
    description:
      'Классические алюминиевые окна ALUTECH: ALT W62, W72, W77. Энергоэффективные, безопасные, срок службы более 50 лет.',
  ...
  <div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
        <div>
          <h1 class="text-4xl font-bold text-gray-900 mb-4">Окна классические</h1>
        ...
        <div>
          <NuxtImg
            ...
            alt="Классические алюминиевые окна ALUTECH"
            width="600"
            height="400"
            loading="lazy"
      ...
      <section class="mb-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div class="text-center">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">Окна с термоизоляцией ALT W72</h2>
            <NuxtImg
              src="/src/components/TypeWindow/assets/фото 2.jpg"
              alt="Окна ALT W72"
              width="500"
              height="350"
              loading="lazy"
          ...
          <div class="text-center">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">
              Окна с повышенной термоизоляцией ALT W77
            </h2>
            <NuxtImg
              src="/src/components/TypeWindow/assets/фото 3.jpg"
              alt="Окна ALT W77"
              width="500"
              height="350"
              loading="lazy"
      ...
      <section class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <NuxtImg
            src="/src/components/TypeWindow/assets/photo_1_1.jpg"
            alt="Проект классических окон 1"
            width="400"
            height="300"
            loading="lazy"
          ...
          />
          <NuxtImg
            src="/src/components/TypeWindow/assets/photo_2_2.jpg"
            alt="Проект классических окон 2"
            width="400"
            height="300"
            loading="lazy"
            class="w-full h-64 object-cover rounded-lg"
          />
          <NuxtImg
            src="/src/components/TypeWindow/assets/photo_3_3.jpg"
            alt="Проект классических окон 3"
            width="400"
            height="300"
            loading="lazy"
            class="w-full h-64 object-cover rounded-lg"
