import { _ as _export_sfc, r as ref, o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, d as createStaticVNode, p as pushScopeId, e as popScopeId, B as ButtonPurple, f as createVNode, w as withCtx, g as resolveComponent, h as createTextVNode, F as Fragment, i as renderList, N as NavbarElement, j as Footer } from "./index-ke8cSA-r.js";
import mobilePhone from "./mobilePhone-fqQutiKs.js";
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-d1370f9c"), n = n(), popScopeId(), n);
const _hoisted_1$4 = { class: "pic_about" };
const _hoisted_2$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("h3", null, "О компании", -1));
const _hoisted_3$3 = {
  class: "text_block",
  ref: "element"
};
const _hoisted_4$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("p", null, "Имея колоссальный опыт работы, мы изучили рынок, сложности и тенденции. Поэтому всегда рады предложить актуальные решения в продуктовой и ценовой политике", -1));
const _hoisted_5$2 = [
  _hoisted_4$2
];
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("section", _hoisted_1$4, [
      _hoisted_2$2,
      createBaseVNode("div", _hoisted_3$3, _hoisted_5$2, 512)
    ]),
    _hoisted_6$2
  ]);
}
const FullDescriptionCompany = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-d1370f9c"]]);
const _sfc_main$3 = {};
...
const ThreeBlock = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-c2cae24a"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-857e634c"), n = n(), popScopeId(), n);
const _hoisted_1$2 = { class: "w_block" };
const _hoisted_2$1 = { class: "two_color_block" };
const _hoisted_3$1 = { class: "left_block" };
...
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", null, "Более 1800 заказчиков используют или просто наслаждаются нашими алюминиевыми конструкциями.", -1));
const _hoisted_6$1 = { class: "right_block" };
const _hoisted_7$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h2", null, "Воплотим вашу мечту о качественном загородном доме", -1));
const _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", null, "Чтобы вы уже через несколько месяцев смогли наслаждаться природой, спокойствием и лучшей жизнью в новом доме с вашей семьей", -1));
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "woman_block" }, [
...
const WomanBlock = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-857e634c"]]);
const _sfc_main$1 = {
  setup() {
...
const _hoisted_1$1 = { class: "about" };
const _hoisted_2 = { class: "about_left" };
const _hoisted_3 = { class: "main_pic" };
const _hoisted_4 = ["src"];
const _hoisted_5 = { class: "mini_elements" };
  ...
  return openBlock(), createElementBlock("section", _hoisted_1$1, [
    createBaseVNode("div", _hoisted_2, [
      ...
      createBaseVNode("ul", _hoisted_5, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($setup.images, (item, index) => {
...
const AboutCompany = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-cc2654b4"]]);
const _sfc_main = {
  name: "HomeView",
  components: {
    NavbarElement,
...
const _hoisted_1 = { style: { "background": "white" } };
